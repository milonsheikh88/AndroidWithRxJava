...
public class CompositeDisposableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        compositeDisposable.addAll(myObserver1,myObserver2);
    }
...
//        myObserver2.dispose();
        ...
        System.out.println("myObserver1 isDisposed =======>>> " + myObserver1.isDisposed());
        System.out.println("myObserver2 isDisposed =======>>> " + myObserver2.isDisposed());
